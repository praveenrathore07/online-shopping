				...
				<div class="panel-body">
					...
					<sf:form class="form-horizontal" modelAttribute="product" action="${contextRoot}/manage/products" method="POST" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<sf:textarea path="description" id="description" rows="4" placeholder="Write a Description here!" class="form-control"></sf:textarea>
						...
						<div class="form-group">
							...
							<sf:select  class="form-control" id="categoryId" path="categoryId" size="1"
								items="${categories}"
								itemLabel="name"
								itemValue="id"
								>
